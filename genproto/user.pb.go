...
var fileDescriptor_116e343673f7ffaf = []byte{
	...
	0x32, 0x62, 0xb3, 0x95, 0x09, 0x87, 0xad, 0xcc, 0xf8, 0x6c, 0x65, 0x41, 0xb7, 0xd5, 0xa8, 0x14,
	0x6e, 0x6b, 0x70, 0x6a, 0x51, 0x19, 0xc8, 0x2c, 0x13, 0x2e, 0x5e, 0xe7, 0xa2, 0xd4, 0xc4, 0x92,
	0x54, 0x58, 0x60, 0x88, 0xe8, 0x81, 0x83, 0x0a, 0xd5, 0x71, 0x52, 0xbc, 0x28, 0xa2, 0x42, 0xba,
	0x5c, 0xbc, 0xa1, 0x05, 0x29, 0x48, 0xba, 0x50, 0xe5, 0xd1, 0x94, 0x3b, 0x09, 0x9c, 0x78, 0x24,
	0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x33, 0x1e, 0xcb, 0x31, 0x24, 0xb1,
	0x81, 0xa3, 0xc2, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x65, 0xc1, 0x79, 0xc7, 0x98, 0x01, 0x00,
	0x00,
}
...
func (c *productServiceClient) UpdateProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
	err := c.cc.Invoke(ctx, "/user.ProductService/UpdateProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductService_UpdateProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.ProductService/UpdateProduct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
